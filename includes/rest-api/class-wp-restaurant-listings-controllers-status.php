...
/**
 * Class WP_Restaurant_Listings_Controllers_Status
 */
class WP_Restaurant_Listings_Controllers_Status extends WP_Restaurant_Listings_REST_Controller_Model
	implements WP_Restaurant_Listings_REST_Interfaces_Controller {
	...
	public function index( $request ) {
		...
		$filter = $this->environment()
			->model( 'WP_Restaurant_Listings_Filters_Status' )
		...
		if ( empty( $configuration ) ) {
			return $this->not_found( __( 'Not Found', 'wp-restaurant-listings' ) );
		}
